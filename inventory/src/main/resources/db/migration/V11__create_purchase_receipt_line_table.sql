...
-- cascade, so no ON DELETE clause is added here. item_id references master
-- data that must not be deleted out from under purchase history ->
-- ON DELETE RESTRICT.
