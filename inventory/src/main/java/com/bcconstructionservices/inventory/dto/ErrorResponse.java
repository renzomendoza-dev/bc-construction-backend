...
public class ErrorResponse {
    ...
    @Schema(description = "Human-readable message describing the error", example = "Item with id 42 was not found")
    private String message;

    @Schema(description = "Request path that produced the error", example = "/api/items/42")
    private String path;
}
