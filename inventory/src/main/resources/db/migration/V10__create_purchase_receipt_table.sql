...
-- supplier_id/warehouse_id reference master data -> ON DELETE RESTRICT on
-- both. created_by/confirmed_by reference the app_user who created/confirmed
-- the receipt.
...
CREATE TABLE purchase_receipt (
    ...
    CONSTRAINT fk_purchase_receipt_created_by
        FOREIGN KEY (created_by) REFERENCES app_user (id),
    CONSTRAINT fk_purchase_receipt_confirmed_by
