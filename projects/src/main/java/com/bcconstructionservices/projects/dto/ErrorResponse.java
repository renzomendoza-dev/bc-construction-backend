...
public class ErrorResponse {
    ...
    @Schema(description = "Human-readable message describing the error", example = "Project with id 42 was not found")
    private String message;

    @Schema(description = "Request path that produced the error", example = "/api/projects/42")
    private String path;
}
