...
-- ------------------------------------------------------------
-- current_warehouse_id 2 = WH-SITE1 "Site Warehouse - Sta. Maria Project"
-- (seeded in V21) - the site each checked-out/in-use item below is at.
INSERT INTO public.equipment
  (id, asset_tag, name, category, serial_number, status, current_holder_id, current_warehouse_id, checked_out_at, purchase_price, purchase_date, purchase_vendor, created_by, updated_by, created_at, updated_at)
VALUES
(1,  'EQ-0001', 'Backhoe Loader (Mini)',            'Heavy Equipment', 'BHL-2023-4471', 'IN_USE',      2,    2,    now() - interval '5 days', 1850000.00, '2023-03-14', 'JM Equipment Rentals & Sales',      1, 1, now(), now()),
...
(4,  'EQ-0004', 'Concrete Mixer (1-bagger)',        'Heavy Equipment', 'CM1B-2022-330', 'CHECKED_OUT', 2,    2,    now() - interval '2 days', 85000.00,  '2022-09-10', 'Wilcon Depot - Bulacan Branch',     1, 1, now(), now()),
...
(9,  'EQ-0009', 'Scaffolding Set (H-Frame, 12 sets)','Site Equipment', 'SC-HF-2021-19', 'IN_USE',      2,    2,    now() - interval '10 days', 120000.00, '2021-07-25', 'JM Equipment Rentals & Sales',      1, 1, now(), now()),
...
INSERT INTO public.equipment_assignment
  (id, equipment_id, assigned_to_id, warehouse_id, checked_out_at, checked_in_at, condition_out, condition_in, created_by, created_at)
VALUES
(1, 1, 2, 2, now() - interval '5 days',  NULL, 'Good condition, full tank on release', NULL, 1, now() - interval '5 days'),
(2, 4, 2, 2, now() - interval '2 days',  NULL, 'Good condition, minor paint wear',      NULL, 1, now() - interval '2 days'),
(3, 9, 2, 2, now() - interval '10 days', NULL, 'Complete set, all pins accounted for',  NULL, 1, now() - interval '10 days');
