...
public class ErrorResponse {
    ...
    @Schema(description = "Human-readable message describing the error", example = "User not found with id: 42")
    private String message;

    @Schema(description = "Request path that produced the error", example = "/api/admin/users/42")
    private String path;
}
