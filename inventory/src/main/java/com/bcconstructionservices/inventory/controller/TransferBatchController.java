...
public class TransferBatchController {
    ...
    @Operation(
            ...
            description = "Applies a draft batch to inventory: this is the step that actually moves stock. "
                    + "For each line item, InventoryService.transferStock is called to move that quantity from "
                    + "the batch's origin warehouse to its destination warehouse. The whole operation is one "
