...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request payload to register new equipment")
public class EquipmentCreateRequest {

    @NotBlank
    @Size(max = 50)
    @Pattern(regexp = "^[A-Za-z0-9._-]+$", message = "assetTag may only contain letters, digits, '.', '_', '-'")
    @Schema(description = "Unique physical asset identifier", example = "EQ-2026-0042", maxLength = 50)
